...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/kevin/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').default({tool: 'webpack', checkSum: '205d610d2d5e6dda39cb44AEoPBh5UCFNRUQMAVFQBDVBaAgUF', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/kevin/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '205d610d2d5e6dda39cb44AEoPBh5UCFNRUQMAVFQBDVBaAgUF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
